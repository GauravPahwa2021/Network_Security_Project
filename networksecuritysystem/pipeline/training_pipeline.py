...
from networksecuritysystem.constant.training_pipeline import TRAINING_BUCKET_NAME
from networksecuritysystem.constant.training_pipeline import SAVED_MODEL_DIR
